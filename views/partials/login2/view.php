        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">View  Login2</h3>
                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        <div class="p-3">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("login2/edit/$data[username]"); ?>">
                                <i class="fa fa-edit"></i> 
                            </a>
                            
                            
                            <a class="btn btn-sm btn-danger recordDeletePromptAction"  href="<?php print_link("login2/delete/$data[username]"); ?>" >
