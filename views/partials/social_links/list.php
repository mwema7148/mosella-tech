        ...
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 comp-grid">
                    <h3 class="record-title">Social Links</h3>
                        ...
                        <div class="">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    if(!empty($field_name)){
                                    ?>
                                    <li class="breadcrumb-item"><a class="text-capitalize" href="<?php print_link('social_links') ?>"><?php echo $field_name ?></a></li>
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('social_links') ?>">Search</a>
                                    </li>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class="card animated fadeIn">
                            <div id="social_links-list-records">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td><a href="<?php print_link("social_links/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">   
                                            <div class="col-sm-3">  
                                                ...
                                                <button data-prompt-msg="Are you sure you want to delete these records" data-url="<?php print_link("social_links/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
                                                ...
                                                <?php Html :: import_form('social_links/import_data' , "", 'CSV , JSON'); ?>
