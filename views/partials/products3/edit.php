        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Edit  Products3</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        <form role="form" enctype="multipart/form-data"  class="form form-horizontal needs-validation" novalidate action="<?php print_link("products3/edit/$page_id"); ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input  id="parts" value="<?php  echo $data['parts']; ?>" type="text" placeholder="Enter Parts"  required="" name="parts" class="form-control " />
