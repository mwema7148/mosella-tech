                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        <div class="page-records ">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="title"> Date Purchased :</th>
                                        <td class="value"> <?php echo $data['date_purchased']; ?> </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="value"> <?php echo $data['product_name']; ?> </td>
                                    </tr>
                        ...
                        <div class="p-3">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("products/edit/$data[serial_number]"); ?>">
                                <i class="fa fa-edit"></i> 
                            </a>
                            
                            
                            <a class="btn btn-sm btn-danger recordDeletePromptAction"  href="<?php print_link("products/delete/$data[serial_number]"); ?>" >
