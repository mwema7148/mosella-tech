<?php
	...
	define('SITE_NAME' , "mosella steel");
	...
	define('APP_ID',"5ddb3aa9e7abcffdcfe4e4f032316a39");
	...
	define('META_AUTHOR','gerald');
	define('META_DESCRIPTION','web-app');
	define('META_KEYWORDS','mosella-tech project');
	...
	define('DEFAULT_EMAIL','mosellatech@gmail.com');
	define('DEFAULT_EMAIL_ACCOUNT_NAME','Mosella-Tech Enterprises');
	...
	define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['id_number'] : null ));
